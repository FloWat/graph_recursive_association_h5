import com.test.hibernate5bug.model.EntityNode;
import com.test.hibernate5bug.model.EntityNode_;
import com.test.hibernate5bug.model.EntitySimple;
...
public class JPAUnitTestCase2 {
    ...
    public void findTest() throws Exception {
        ...
        List<EntitySimple> listWithGraph = entityManager.createQuery("select e from EntitySimple e "
            , EntitySimple.class).setHint("javax.persistence.fetchgraph",graph).getResultList();
